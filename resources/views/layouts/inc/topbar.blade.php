    ...
    <div class="kt-header__topbar">
        <div class="kt-header__topbar-item kt-header__topbar-item--user">
            ...
            <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-sm">
                <div class="kt-user-card kt-margin-b-40 kt-margin-b-30-tablet-and-mobile" style="background-image: url({{ asset('media/misc/head_bg_sm.jpg') }})">
                    <div class="kt-user-card__wrapper">
                        <div class="kt-user-card__details">
                            <div class="kt-user-card__name">{{ $authUser->name }}</div>
                            <div class="kt-user-card__position">{{ $authUser->roles()->select('display_name')->first()->display_name }}</div>
                        </div>
                    </div>
                </div>
